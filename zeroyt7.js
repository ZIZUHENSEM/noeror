...
`
teks =
`Jangan Lupa Bersyukur Ya kawan wogwog`
but = [
          { buttonId: `${prefix}infobot`, buttonText: { displayText: '☰ INFO' }, type: 1 },
          { buttonId: `${prefix}owner`, buttonText: { displayText: '☰ OWNER' }, type: 1 }
        ]
...
case 'instagram':
teks =
`Nih Instagram Owner Ku Jangan Lupa Di Follow Ya https://instagram.com/zizuelite`
zeroyt7.sendMessage(from, teks, text, {quoted: ftrol})
break
case 'tiktok':
teks =
`Nih Tiktok Owner Ku Jangan Lupa Di Follow Ya https://tiktok.com/@zizuy.a`
zeroyt7.sendMessage(from, teks, text, {quoted: ftrol})
break
case 'sourcecode':
case 'script':
...
await zeroyt7.sendMessage(from, ini_buffer, video, { quoted: ftrol, caption: 'AMBIL ANJG BY : ZIZUELITE'})
break
case 'tiktokmusic':
...
await zeroyt7.sendMessage(from, ini_buffer, image, { quoted: ftrol, caption: 'AMBIL ANJG BY : ZIZUELITE'})
break
case 'instagram':
case 'ig':
case 'igdl': 
...
zeroyt7.sendMessage(from, buffer, video, {quoted: ftrol, caption: 'AMBIL ANJG BY : ZIZUELITE', thumbnail: Buffer.alloc(0)})
break
case 'asupancecan':
ini = await fetchJson(`https://zeroyt7-api.herokuapp.com/api/asupan/cecan?apikey=${zerkey}`)
reply(mess.wait)
buffer = await getBuffer(ini.result.url)
zeroyt7.sendMessage(from, buffer, image, {quoted: ftrol, caption: 'AMBIL ANJG BY : ZIZUELITE', thumbnail: Buffer.alloc(0)})
break
case 'asupanhijaber':
...
reply(mess.wait)
zeroyt7.sendMessage(from, gambar, image, {quoted: ftrol, caption: 'AMBIL ANJG BY : ZIZUELITE', thumbnail: Buffer.alloc(0)})
})
break
case 'darkjoke':
...
reply(mess.wait)
zeroyt7.sendMessage(from, gambar, image, { quoted: ftrol, caption: 'AMBIL ANJG BY : ZIZUELITE'})
})
break
